## Water Quality Streamlit Dashboard App
My first streamline app made in course CIS 3590
## Overview
...
- pH
- Salinity
- Depth and water column measurements
- Battery and power system metrics
- Time and date stamps

## Features
- Descriptive statistics table
- 2D line plots of environmental variables over time
- 3D scatter plots of spatial and depth-related data
- NASA Astronomy Picture of the Day integration using the NASA Open API
